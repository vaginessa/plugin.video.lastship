...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem("Freigabe (US/MPAA)", 'movieCertificates', 'certificates.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem("Freigabe (US/MPAA)", 'tvCertificates', 'certificates.png', 'DefaultTVShows.png')
